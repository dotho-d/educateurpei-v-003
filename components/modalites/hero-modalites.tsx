...
interface HeroModalitesProps {
  onScrollToSection: (targetId: string) => void;
}

const HeroModalites = forwardRef<HTMLElement, HeroModalitesProps>(
  function HeroModalites({ onScrollToSection }, ref) {
    const { trackEvent } = useAnalytics();

    const handleCTAClick = () => {
      trackEvent('hero_cta_click', { page: 'modalites' });
      onScrollToSection('processus');
    };
            ...
            <div className="w-full z-20 text-center lg:text-left space-y-6 lg:space-y-8 mt-4 sm:mt-8 md:mt-16 lg:mt-0">
              ...
              <div className="space-y-4">
                <p className="body-text text-muted-foreground">
                  Découvrez notre processus simplifié et innovant pour vous accompagner efficacement.
                </p>
                <p className="body-text text-muted-foreground">
                  De la prise de rendez-vous au suivi personnalisé, nous mettons la technologie au service de l'humain.
                </p>
              </div>
              ...
              <div className="flex justify-center lg:justify-start pt-4">
                <Button
                  ...
                  aria-label="Découvrir le processus"
                >
              ...
              <div className="hero-image-container">
                <div className="hero-image-wrapper">
                  <Image
                    ...
                    alt="Processus d'intervention moderne et personnalisé"
                    fill

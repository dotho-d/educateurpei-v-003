...
const HeroFAQ = forwardRef<HTMLElement, HeroFAQProps>(
  function HeroFAQ({ onScrollToSection }, ref) {
    const { trackEvent } = useAnalytics();

    const handleCTAClick = () => {
      trackEvent('hero_cta_click', { page: 'faq' });
      onScrollToSection('search');
    };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="w-full z-20 text-center lg:text-left space-y-6 lg:space-y-8 mt-4 sm:mt-8 md:mt-16 lg:mt-0">
              ...
              <div className="space-y-4">
                ...
                <p className="body-text text-muted-foreground">
                  Notre assistant virtuel est également disponible 24h/24 pour vous aider.
                </p>
              </div>
